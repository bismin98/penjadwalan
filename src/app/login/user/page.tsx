        ...
        <div className="grid gap-6 sm:gap-10 md:grid-cols-[1.1fr_1fr]">
          ...
          <section className="rounded-2xl sm:rounded-3xl border border-black/10 bg-white/80 p-4 sm:p-6">
            <form className="space-y-4 sm:space-y-5">
              ...
              <span></span>
              <Link
                className="inline-flex w-full items-center justify-center rounded-full bg-linear-to-r from-orange-500 via-pink-500 to-purple-500 px-4 py-2.5 sm:px-5 sm:py-3 text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] text-white transition hover:-translate-y-px hover:shadow-lg"
                href="/user/dashboard"
              >
                Masuk Pengguna
              </Link>
